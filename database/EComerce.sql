...
CREATE TABLE tbl_producto (
  ...
  precio_compra_producto DECIMAL(16, 2),
  precio_venta_producto DECIMAL(16, 2),
  id_estado INT,
...
CREATE TABLE tbl_venta_detalle (
  ...
  descuento_venta_detalle DECIMAL(16, 2),
  subtotal_venta_detalle DECIMAL(16, 2),
...
CREATE TABLE tbl_compra (
  ...
  fecha_compra DATE,
  monto_total_compra DECIMAL(16, 2),
...
CREATE TABLE tbl_compra_detalle (
  ...
  precio_unitario_producto_dcompra DECIMAL(16, 2),
  subtotal_dcompra DECIMAL(16, 2),
...
CREATE TABLE tbl_historial_cxc (
  ...
  monto_pagado_historial_cxc DECIMAL(16, 2),
  id_metodo_pago INT,
...
CREATE TABLE tbl_historial_cxp (
  ...
  monto_pagado_historial_cxp DECIMAL(16, 2),
  id_metodo_pago INT,
...
CREATE TABLE tbl_caja (
  ...
  id_sucursal INT,
  saldo_inicial_caja DECIMAL(16, 2),
  saldo_actual_caja DECIMAL(16, 2),
...
CREATE TABLE tbl_apertura_caja (
  ...
  id_usuario INT,
  saldo_inicial_apertura_caja DECIMAL(16, 2),
  id_estado INT,
...
CREATE TABLE tbl_detalle_apertura_caja (
  ...
  id_metodo_pago INT,
  monto_det_apertura_caja DECIMAL(16, 2),
